    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div id="poly-atlas-heading">
          ...
          <a id="github-link" href="https://github.com/thepolygroup/polyatlas" target="_blank" style="float: right;color: #FFFFFF88;"><i class="fa-brands fa-github" style="margin-right: 2px;"></i> an open-source project</a>
        ...
        <h2 id="getting-started">Getting Started</h2>
          ...
          <p>All along this workflow you will find entries titled "The Poly Group" which showcase how we, at The Poly Group, have performed each task.</p>
          ...
          <p>All authored content within this document is distributed for free by <a href="http://mynameisboris.com" target="_blank">Boris Hrncic</a> &amp; <a href="http://thepolygroup.co" target="
            ">The Poly Group</a> under a <a rel="license" href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International License</a>.</p>
          <p>Furthermore, this is a collection of what we at <a href="http://thepolygroup.co" target="_blank">The Poly Group</a> consider to be the best practices in Branding, but other authors may digress.</p>
