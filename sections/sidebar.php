...
<a id="toc-default-title" title="Table of Contents" onclick="document.getElementById('sidebar-wrapper').className='open-sidebar';document.getElementById('open-sidebar-button').className='d-none';">
  Table of Contents
</a>
...
<div id="sidebar-wrapper" class="open-sidebar">
  ...
  <div id="sidebar-title"><a onclick="document.getElementById('sidebar-wrapper').className='d-none';document.getElementById('open-sidebar-button').className='toc-button';" ><!--<img src="poly-atlas.svg" style="background:none;border-radius: 0;height:25px;width:auto;margin:0;">-->Table of Contents</a></div>
  <div id="sidebar">
