...
<!-- INCLUDE HEAD.PHP end -->
  ...
  <body id="brand-strategy-container" class="light-theme">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <hr class="third-separator">
        <img src="imgs/authentic-weather-app.png">
        ...
        <hr class="third-separator">
        <small>Task</small>
          <h4>Design Moodboard's layout</h4>
        <small>Role</small>
        <p>Brand designer</p>
        <small>Estimated workload</small>
        <p>1 hour</p>
        ...
        <h5>1.  Easy to pronounce correctly</h5>
        <div class="indent">
        ...
        <h5>2.  Easy to spell correctly</h5>
        <div class="indent">
        ...
        <img src="imgs/lowercase-logos.jpg">
        ...
        <img src="imgs/uppercase-logos.jpg">
        ...
        <img src="imgs/smallcaps-logos.jpg">
        ...
        <p>0.5&thinsp;&ndash;&thinsp;1.5 hours</p>
        <small>Description</small>
        <img src="imgs/microsoft-windows.jpg">
        ...
        <hr class="third-separator">
        <small>Task</small>
        <h4>Define the relationship between the Brands</h4>
        <small>Role</small>
        <p>Marketing Analyst</p>
        <small>Estimated workload</small>
        <p>0.5&thinsp;&ndash;&thinsp;1.5 hours</p>
        ...
        <img src="imgs/game-of-thrones-lagavulin.jpg">
        ...
        <img src="imgs/game-of-thrones.jpg">
        ...
        <img src="imgs/business-structure-and-brand-architecture.jpg">
        ...
        <small>The Poly Group</small>
        <img src="imgs/the-poly-group-architecture.jpg">
        ...
        <small>Task</small>
        <h4>Write an About paragraph</h4>
        <small>Role</small>
        <p>Marketing Analyst</p>
        <small>Estimated workload</small>
        <p>0.5&thinsp;&ndash;&thinsp;1.5 hours</p>
